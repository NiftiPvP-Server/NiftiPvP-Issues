...
> **ВНИМАНИЕ!** Изменять файлы репозитория, менять теги, файл README и все это __запрещено__, и карается **КИКОМ ИЗ ПРОГРАММЫ ТЕСТИРОВЩИКОВ**, а также блокировкой на всей серверах Nifti. Это важно - все, что вы можете тут в репозитории делать, это во вкладке Issues создавать свои ответы и писать комментарии к чужим. Изменять чужие отчеты вы также не можете.
